  ...
  <section class="py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto gradient-bg">
    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      >
        ...
        <div class="p-4">
          <h3
            class="text-lg font-semibold text-white mb-1 hover:cursor-pointer"
            @click="showProductDetails(product)"
          >
            {{ product.name }}
          </h3>
          <p class="text-white text-sm mb-2 hover:cursor-pointer">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
            ...
            <div class="flex flex-col">
              ...
              <p class="text-sm text-gray-500 mt-2">
                Par {{ selectedProduct.partner.name }}
              </p>
              ...
              <div class="mt-8 flex items-center justify-between">
                ...
                <button
                  ...
                  v-if="selectedProduct.stock_level === 'En stock'"
