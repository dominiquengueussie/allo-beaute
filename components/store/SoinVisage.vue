...
<template>
    <section class="py-12 px-4 sm:px-6 lg:px-8 max-w-[1400px] mx-auto bg-white mt-10 md:mt-10 sm:mt-20 lg:mt-10 rounded-xl shadow-sm border border-gray-100">
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Soins de visage</h2>
                <p class="text-gray-600">Découvrez nos produits pour un visage éblouissant</p>
            </div>
            <!--   <a href="#" class="text-[#fac9a0] hover:text-pink-600 font-medium flex items-center">
                Voir tout
                <ChevronRight />
            </a> -->
        </div>
